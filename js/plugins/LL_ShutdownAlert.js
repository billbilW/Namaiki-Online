...
(function() {
    ...
    if (typeof nw === "undefined") {
        console.warn("LL_ShutdownAlert: NW.js specific close handling skipped in non-NW environment.");
        return;
    }

    // NW.js環境下でのみ実行
    if (typeof nw !== "undefined" && Utils.isNwjs() && !Utils.isOptionValid("btest") && !Utils.isOptionValid("etest")) {
